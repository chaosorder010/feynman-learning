...
import { registerSiteTools, buildSite } from "./state/site.js";
...
export default function feynmanState(pi: ExtensionAPI) {
	...
	// statically importing progress, keeping the import graph acyclic. buildSite is
	// injected for the same reason (feynman_record_review lives in concept-index).
	registerConceptIndexTools(pi, { mergeProgress, buildSite });
